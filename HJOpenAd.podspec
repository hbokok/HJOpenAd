...
TODO: Add long description of the pod here.
  ...
  s.dependency 'ToBid-iOS/ToBidSDK','4.0.1'
  s.dependency 'ToBid-iOS/MintegralAdapter','4.0.1'
  s.dependency 'ToBid-iOS/GDTAdapter','4.0.1'
  s.dependency 'ToBid-iOS/BaiduAdapter','4.0.1'
  s.dependency 'ToBid-iOS/KSAdapter','4.0.1'
  s.dependency 'ToBid-iOS/TouTiaoAdapter','4.0.1'
  s.dependency 'ToBid-iOS/CSJMediationAdapter','4.0.1'
